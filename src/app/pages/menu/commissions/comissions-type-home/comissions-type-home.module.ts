...
import { ComissionsTypeHomePageRoutingModule } from './comissions-type-home-routing.module';
...
@NgModule({
  imports: [
    ...
    FormsModule,
    IonicModule,
    ComissionsTypeHomePageRoutingModule,
    CustomHeaderModule,
  ...
  declarations: [ComissionsTypeHomePage]
})
export class ComissionsTypeHomePageModule {}
