...
@Component({
  selector: 'app-budgets-crud',
  templateUrl: './budgets-crud.page.html',
  styleUrls: ['./budgets-crud.page.scss'],
})
export class BudgetsCrudPage extends PageCore {
  public call;
  public id;
  ...
  constructor(
    ...
    this.route.queryParams.subscribe(async (params: any) => {
      ...
      if (this.id) {
        ...
        const find = this.budget.find(this.id);
        this.call = find ? find : await this.budget.getHttp(this.id);
  ...
  override setData() {
    const tab = this.findSelectedTab(this.budget.tabs);
    this.budget.selectedTab = tab;
    console.log(this.budget.selectedTab);
  ...
  back() {
    this.navigation.goTo('budgets-home');
  }
}
