...
import { CancellationReasonHomePageRoutingModule } from './cancellation-reason-home-routing.module';
...
@NgModule({
  imports: [
    ...
    FormsModule,
    IonicModule,
    CancellationReasonHomePageRoutingModule,
    CustomHeaderModule,
  ...
  declarations: [CancellationReasonHomePage],
})
export class CancellationReasonHomePageModule {}
