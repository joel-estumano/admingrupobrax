...
import { CategoriesHomePageRoutingModule } from './categories-home-routing.module';
...
@NgModule({
  imports: [
    ...
    FormsModule,
    IonicModule,
    CategoriesHomePageRoutingModule,
    CustomHeaderModule,
  ...
  declarations: [CategoriesHomePage],
})
export class CategoriesHomePageModule {}
