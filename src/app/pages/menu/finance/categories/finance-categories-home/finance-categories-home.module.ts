...
import { FinanceCategoriesHomePageRoutingModule } from './finance-categories-home-routing.module';
...
@NgModule({
  imports: [
    ...
    FormsModule,
    IonicModule,
    FinanceCategoriesHomePageRoutingModule,
    CustomHeaderModule,
  ...
  declarations: [FinanceCategoriesHomePage]
})
export class FinanceCategoriesHomePageModule {}
