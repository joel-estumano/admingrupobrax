...
@Injectable()
export class FinanceCategoriesClass extends Core {
  override cachePath = 'FinanceCategories';
  override path = 'FinanceCategories';
  data: any = [];
  show: any = [];
  pages: any = [];
  currentPage = 0;
  ...
  public headers = ['Código', 'Categoria', 'Criado em', 'Ação'];
  constructor(
