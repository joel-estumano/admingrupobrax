...
@Injectable()
export class DeliveryClass extends Core {
  override cachePath = 'DeliveryForms';
  override path = 'DeliveryForms';
  data: any = [];
  show: any = [];
  pages: any = [];
  currentPage = 0;
  ...
  public headers = ['Código', 'Forma de Entrega', 'Criado em', 'Ação'];
  constructor(
